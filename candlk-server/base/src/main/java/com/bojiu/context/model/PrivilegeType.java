...
public enum PrivilegeType implements LabelI18nProxy<PrivilegeType, Integer> {
	...
	/** 日提款次数 */
	DAILY_CASH_NUM(7, PRIVILEGE_TYPE_DAILY_CASH, Calendar.DATE),
	/** 日提款限额 */
	DAILY_CASH_LIMIT(8, PRIVILEGE_TYPE_CASH_LIMIT, Calendar.DATE),
	/** 每日奖励 */
	...
	/** 总提款次数 */
	TOTAL_CASH_NUM(12, PRIVILEGE_TYPE_TOTAL_CASH_NUM, Calendar.YEAR),
	/** 总提款限额 */
	TOTAL_CASH_LIMIT(13, PRIVILEGE_TYPE_TOTAL_CASH_LIMIT, Calendar.YEAR),
	/** 日免手续费次数 */
	DAILY_FEE_NUM(14, PRIVILEGE_TYPE_DAILY_FEE_NUM, Calendar.DATE),
	/** 提现 限制提示语 */
	...
	/** VIP特权：日提款次数、日提款限额、总提款次数、总提款限额、日免手续费次数 */
	public static final List<PrivilegeType> VIP_PRIVILEGE = Arrays.asList(DAILY_CASH_NUM, DAILY_CASH_LIMIT, TOTAL_CASH_NUM, TOTAL_CASH_LIMIT, DAILY_FEE_NUM);
	// 获取特权下的奖励类型
